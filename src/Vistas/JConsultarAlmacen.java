 ...
 */
public class JConsultarAlmacen extends javax.swing.JFrame {

    /**
     * Creates new form JConsultarJAlmacen
     */
    public JConsultarAlmacen() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JConsultarAlmacen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JConsultarAlmacen().setVisible(true);
            }
        });
    }
